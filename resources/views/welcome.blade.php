...
<div class="container">
    ...
    <div class='row @if(count($books)!= 0) show @else hidden @endif' id='articles-wrap'>
        ...
        <table class="table table-striped ">
            ...
            @foreach($books as $book)
                ...
                <tr>
                    ...
                    <td><a href="" class="delete" data-href=" {{ route('book.destroy',$book->id) }} ">Удалить</a></td>
    ...
    <div class="row">
        ...
        <div class="alert alert-warning @if(count($books) != 0) hidden @else show @endif" role="alert"> Записей нет</div>
